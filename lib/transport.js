...
module.exports = {
  ...
  setTypeInclude: function(){
    ...
    if(this.fileName.indexOf('article-list')!=-1) {
      ...
      // include 文章终极页
      var article_fragment_1 = fs.readFileSync(thisPath + '/app/template/inc-article/inc-article-1.shtml', {encoding:'utf8'}),
          article_fragment_2 = fs.readFileSync(thisPath + '/app/template/inc-article/inc-article-2.shtml', {encoding:'utf8'}),
          article_fragment_3 = fs.readFileSync(thisPath + '/app/template/inc-article/inc-article-3.shtml', {encoding:'utf8'});
